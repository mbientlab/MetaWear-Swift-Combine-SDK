...
Add your local machine's MetaWears to `TestDevices.swift`. 

Tip: If you don't have your MetaWear's local UUID memorized, run the test host app and tap on the MetaWear to copy its UUID and MAC address to the clipboard.
